    ...
    return (
        <main className="bg-blue-900 text-white py-8">
            <div className="max-w-screen-lg mx-auto flex-col ">
                ...
                <div className="grid md:grid-cols-4 md:gap-4 grid-cols-2 gap-2 place-items-center">
                    <a href="https://la-rocks.com/" target="_blank" rel="noopener noreferrer">
                        <img src="/assets/images/sponsors/larocks.png" alt="LA Rocks"
                             className="w-36 h-36 md:w-72 md:h-72 rounded-lg mb-4 ml-1.5 md:ml-0 transform transition-transform duration-200 hover:scale-105"/>
                    </a>
